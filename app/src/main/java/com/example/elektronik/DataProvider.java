...
public class DataProvider {
    ...
    private static List<Handphone> initHandphone(Context ctx) {
    ...
    private static List<Laptop> initLaptop(Context ctx) {
    ...
    private static List<Televisi> initTv(Context ctx) {
    ...
    private static void initAllElektronik(Context ctx) {
        elektroniks.addAll(initHandphone(ctx));
        elektroniks.addAll(initLaptop(ctx));
        elektroniks.addAll(initTv(ctx));
    }
